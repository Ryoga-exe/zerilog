...
pub const Node = struct {
    ...
    pub const Data = union(enum) {
        ...
        if_expr: struct { cond: Node.Index, then_expr: Node.Index, else_expr: Node.Index },
        switch_expr: struct { cond: Node.Index, cases: SubRange, else_expr: Node.OptionalIndex },
        switch_case: struct { value: Node.Index, expr: Node.Index },
